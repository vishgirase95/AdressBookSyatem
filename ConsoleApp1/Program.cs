    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (YesOrNO == "Y")
            {
                ...
                Console.WriteLine("Do You want to create New Contact or Remove Contact, Please type Y or N ");
                YesOrNO = Console.ReadLine().ToUpper();
                if (YesOrNO == "N")


                    break;
                Console.WriteLine("\n \n Please Enter the Name If you want to Remove or leave blank");
                string NameToRemove = Console.ReadLine();
                Contact.Remove(NameToRemove);
                Console.WriteLine($"\n ****************************{NameToRemove} Contact Detail Removed********************\n \n");

                Console.WriteLine("Do You want still Continue, Y or N? ");
                YesOrNO = Console.ReadLine().ToUpper();
